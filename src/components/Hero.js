    ...
    <section className="hero">
      <div className="container-fluid">
        ...
        <div className="content">
          <h2>Explore<br /><span>CoolCriminal_Universe NFTs Saga</span></h2>

          <div className="container panel">
            <div className="row">
              <div className="col">
                <img className="img secondary-image" src={require('../images/01.png')} alt="01" />
              </div>
              <div className="col">
                <img className="img tertiary-image" src={require('../images/ava02.png')} alt="02" />
                <img className="img tertiary-image" src={require('../images/03.png')} alt="03" />
              </div>
              <div className="col">
                <img className="img main-image" src={require('../images/04.png')} alt="04" />
              </div>
              <div className="col">
                <img className="img tertiary-image" src={require('../images/05.png')} alt="05" />
                <img className="img tertiary-image" src={require('../images/ava06.png')} alt="06" />
              </div>
              <div className="col">
                <img className="img secondary-image" src={require('../images/07.png')} alt="07" />
              </div>
            </div>
          </div>
